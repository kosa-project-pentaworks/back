//package com.reservation.global.batch.hospitalReservation.schedule;
//
...
//@Component
//public class HospitalReservationSchedule {
...
//        try {
//            Job job = jobRegistry.getJob("hospitalReservationJob");
